...
class Email{
    ...
    public function enviarConfirmacion(){
        ...
        $mail->setFrom('cuentas@uptask.com'); //quien esta mandando el email al destinatario? 
        $mail->addAddress($this->email, $this->nombre); //para quien va el correo, el nombre de la persona :D
        ...
        en UpTask, solo debes confirmarla en el siguiente enlace</p>";
